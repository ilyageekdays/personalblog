 ...
 * Содержит обновляемые данные пользователя.
 */
@Data
...
public class UpdateUserRequest {
    ...
    @Schema(
            description = "Обновляемое отображаемое имя пользователя",
    ...
    @Schema(
            description = "Обновляемое имя пользователя (логин)",
            example = "alex_petrov",
            requiredMode = Schema.RequiredMode.REQUIRED,
            minLength = 3,
            maxLength = 20,
    ...
    @Schema(
            description = "Обновляемый email пользователя",
